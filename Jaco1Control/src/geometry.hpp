...
void circle_imp_print_2d ( double r, double center[2], std::string title );
void circle_imp_print_3d ( double r, double pc[3], double nc[3], std::string title );
...
void points_hull_2d ( int node_num, double node_xy[], int *hull_num,
  int hull[] );
void points_plot ( std::string file_name, int node_num, double node_xy[],
  bool node_label );
...
void r8vec_print_2d ( double x, double y, std::string title );
void r8vec_print_3d ( double x, double y, double z, std::string title );
...
void tmat_shear ( double a[4*4], double b[4*4], std::string axis, double s );
